...
namespace Фоновая_5._1_2_вар
{
    class Vehicle
    {
        ...
        new public double fuelS(double LenRoute)
        {
    ...
    class Car : Vehicle
    {
        ...
        public void output()
        {
            ...
            Console.WriteLine("Название {0}, потребление топлива на 100км {1}, объем бака {2}, вид кузова {3}, кол-во пассажиров {4}", title, fuelCons, fuelTankCap, body, numPass);
        }
        public int NumPass
        {
            get { return numPass; }
    ...
    class Truck : Vehicle
    {
        ...
        public void output()
        {
            Console.WriteLine("Название {0}, потребление топлива на 100км {1}, объем бака {2}, грузоподъемность {3}, масса груза {4}", title, fuelCons, fuelTankCap, carrycap, cargoWeight);
        }
        ...
        public double fuelS(double carMass, double S)
        {
